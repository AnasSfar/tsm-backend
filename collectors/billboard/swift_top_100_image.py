    ...
    *,
    ...
    def _render_table(chunk: list[dict[str, Any]]) -> str:
        ...
        out.append(
            ...
            "<th rowspan='2' class='c-yt'>YouTube</th>"
        ...
        for r in chunk:
            ...
            yt_s = html.escape(str(e.get("youtube_units_display") or "—"))
            ...
            yt_pct = _component_pct(e, previous, ["units_youtube", "youtube_units_display"])
            ...
            out.append(f"<td class='td-num td-yt'>{_metric_cell(yt_s, yt_pct)}</td>")
    ...
    .c-yt     {{ background: rgba(255, 0, 51, 0.08); color: #ff0033; font-weight: 700; }}
    .td-yt    {{ background: rgba(255, 0, 51, 0.04); }}
