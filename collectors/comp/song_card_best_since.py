"""Best-since-style song card CSS — used by post_best_day_since_twitter.py.
...
def build_css(*, gradient: str, title_font_size: int, body_gap: int, badge_bg: str, badge_fg: str) -> str:
    return f"""
