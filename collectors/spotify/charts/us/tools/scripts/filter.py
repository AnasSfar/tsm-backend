...
if ARCHIVE_CSV.name != "charts_history_us.csv":
    raise RuntimeError(f"Invalid ARCHIVE_CSV target for US: {ARCHIVE_CSV}")
...
def append_to_archive_csv(chart_date: str, ts_df) -> None:
    """Appende les donnees TS du jour dans db/charts_history_us.csv si absentes."""
